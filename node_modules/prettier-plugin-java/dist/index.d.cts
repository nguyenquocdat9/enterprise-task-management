...
declare const _default: {
  ...
  printers: {
    java: {
      print(path: import("prettier").AstPath<SyntaxNode>, options: import("prettier").ParserOptions<SyntaxNode>, print: (path: import("prettier").AstPath<SyntaxNode>) => import("prettier").Doc, args: unknown): import("prettier/doc.js").builders.Doc;
      embed(path: import("prettier").AstPath<any>): ((textToDoc: (text: string, options: import("prettier").Options) => Promise<import("prettier").Doc>) => Promise<import("prettier/doc.js").builders.Indent | import("prettier/doc.js").builders.Doc[]>) | null;
